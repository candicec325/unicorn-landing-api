...
async function main() {
  ...
  // Hash passwords using Better Auth's crypto
  ...
  // Create admin account (for password) - check if exists first
  ...
  // Create user account (for password) - check if exists first
